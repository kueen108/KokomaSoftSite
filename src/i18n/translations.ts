...
export const translations = {
  ko: {
    ...
    heroSubtitle: '왕꽃선녀, 스마트밥, MarkNote, StyleCue 등 일상과 생산성을 위한 앱을 만들고 공식 다운로드, 지원, 개인정보 안내를 제공합니다.',
    appsTitle: '우리의 앱',
  ...
  en: {
    ...
    heroSubtitle: 'KokomaSoft builds everyday and productivity apps including Ungyeol, SmartBap, MarkNote, and StyleCue, with official downloads, support, and privacy information.',
    appsTitle: 'Our Apps',
  ...
  zh: {
    ...
    heroSubtitle: 'KokomaSoft 开发 Ungyeol、智慧餐盘、MarkNote、StyleCue 等日常与效率应用，并提供官方下载、支持和隐私信息。',
    appsTitle: '我们的应用',
  ...
  ja: {
    ...
    heroSubtitle: 'KokomaSoftはUngyeol、スマートごはん、MarkNote、StyleCueなどの日常・生産性アプリを開発し、公式ダウンロード、サポート、プライバシー情報を案内します。',
    appsTitle: '私たちのアプリ',
